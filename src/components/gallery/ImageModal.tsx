...
export function ImageModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-sage-900/60 backdrop-blur-soft"
        onClick={onClose}
      />
      ...
      <div className="relative bg-white rounded-2xl shadow-lifted max-w-5xl w-full max-h-[90vh] overflow-hidden animate-fade-in flex">
        ...
        <div className="relative w-3/5 bg-sage-100">
          ...
          {/* Filename */}
          <div className="absolute bottom-4 left-4 bg-sage-900/70 text-white text-sm px-3 py-1.5 rounded-lg">
            {image.filename}
          </div>
        </div>
        ...
        <div className="w-2/5 p-6 flex flex-col">
          ...
          {/* Header */}
          <div className="mb-6">
            <h3 className="font-serif text-xl text-sage-800 mb-1">
              Image Details
            </h3>
          ...
          {isSelected && (
            <div className="mb-6 animate-fade-in">
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative">
                  ...
                  <div className={`
                    ...
                    peer-checked:bg-sage-500 transition-colors duration-300
              ...
              <p className="text-sage-400 text-xs mt-2 ml-15">
          ...
          {!isSelected && (
            <div className="flex-1 flex items-center justify-center text-center">
              <div>
                <p className="text-sage-400 mb-2">
