  ...
  return (
    <div className="p-8 lg:p-12">
      ...
      <header className="mb-12 max-w-4xl">
        <h1 className="font-serif text-4xl lg:text-5xl text-sage-900 mb-3 tracking-tight">
          {greeting}, <span className="text-sage-600 block sm:inline">{firstName}.</span>
        </h1>
      ...
      {projects && projects.length > 0 ? (
        ...
        <section className="text-center py-16">
          <div className="max-w-md mx-auto">
            ...
            <h2 className="font-serif text-2xl text-sage-700 mb-3">
              No sessions yet
            </h2>
